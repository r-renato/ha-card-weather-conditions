...
`;let _t={en:0,it:1},yt={N:["N","N"],NNE:["NNE","NNE"],NE:["NE","NE"],ENE:["ENE","ENE"],E:["E","E"],ESE:["ESE","ESE"],SE:["SE","SE"],SSE:["SSE","SSE"],S:["S","S"],SSW:["SSW","SSO"],SW:["SW","SO"],WSW:["WSW","OSO"],W:["W","O"],WNW:["WNW","ONO"],NW:["NW","NO"],NNW:["NNW","NNO"]};function ft(t){return new Promise(e=>{setTimeout(()=>{let i=new Image;i.onload=(()=>{e(!0)}),i.onerror=(()=>{e(!1)}),i.src=t},100)})}const vt=(t,e,i)=>{let s=i&&"below_horizon"==i;return null==e.path&&console.info("Image path not found. (hacsImagePathExist="+kt+")(manImagePathExist="+Tt),`${e.path}/${e.iconType}/${s?e.iconsNight[t]:e.iconsDay[t]}.svg`},wt=(t,e)=>{const i=t.config.unit_system.length;switch(e){case"air_pressure":return"km"===i?"hPa":"inHg";case"length":return i;case"precipitation":return"km"===i?"mm":"in";default:return t.config.unit_system[e]||""}},bt=(t,e,i,s,n)=>void 0!==t||void 0!==i?j`
    <li>
