...
        <text x="0" y="14" class="small">${t}</text>
  ...
  `:""},Le=(e,t,i)=>{let s=void 0!==t.protection_window&&e.states[t.protection_window]?qe(e.states[t.protection_window],"mdi:sunglasses",!1):void 0,n=void 0!==t.uv_level&&e.states[t.uv_level]?qe(e.states[t.uv_level],"mdi:weather-sunny",!1):void 0,o=((e,t,i)=>{let s=Math.round(10*parseFloat(e.state))/10,n=Math.round(10*parseFloat(t.state))/10;return e||t?j`
    <li>
  ...
  `},Re="/local/community/ha-card-weather-conditions/icons",Ie="/local/ha-card-weather-conditions/icons";let De=!1,He=!1,Be="%c WEATHER-CONDITION-CARD %c 1.5.1",Ge="color: white; background: green; font-weight: 700;",Ze="color: green; background: white; font-weight: 700;",Qe="color: black; background: white; font-weight: 700;";console.info(Be,Ge,Ze),Promise.all([Ce(Re+"/static/cloudy.svg"),Ce(Ie+"/static/cloudy.svg")]).then(t=>{let i,s;i=De=t[0],s=He=t[1],i?console.info(Be+"%c use HACS path to retrieve icons.",Ge,Ze,Qe):s?console.info(Be+"%c use www root path to retrieve icons.",Ge,Ze,Qe):console.info(Be+"%c error setting right icons path.",Ge,Ze,Qe);let n=class extends ce{constructor(){super(...arguments),this._iconsConfig=new class{},this._bgConfig=new class{},this.invalidConfig=!1,this.numberElements=0,this._header=!0,this._name="",this._hasCurrent=!1,this._hasForecast=!1,this._hasMeteogram=!1,this._hasAirQuality=!1,this._hasPollen=!1,this._hasUv=!1,this._displayTop=!0,this._displayCurrent=!0,this._displayForecast=!0,this._showSummary=!0,this._showPresent=!0,this._showUv=!0,this._showAirQuality=!0,this._showPollen=!0,this._showForecast=!0}setConfig(e){if(console.log({card_config:e}),!e)throw this.invalidConfig=!0,new Error("Invalid configuration");if(e.name&&e.name.length>0&&(this._name=e.name),e.language&&e.language.length>0?this._language=e.language.toLowerCase():this._language="en",void 0!==e.display&&(this._displayTop=e.display.findIndex(e=>"top"===e.toLowerCase())>=0,this._displayCurrent=e.display.findIndex(e=>"current"===e.toLowerCase())>=0,this._displayForecast=e.display.findIndex(e=>"forecast"===e.toLowerCase())>=0),this._hasCurrent=!!e.weather&&!!e.weather.current,this._hasForecast=!!e.weather&&!!e.weather.forecast,this._hasMeteogram=this._hasForecast&&!!e.weather.forecast.meteogram,this._hasAirQuality=!!e.air_quality,this._hasPollen=!(!e.pollen||!e.pollen.tree&&!e.pollen.weed&&!e.pollen.grass),this._hasUv=!!e.uv,this._bgConfig.path=i?Re:s?Ie:null,this._bgConfig.iconsDay=fe,this._bgConfig.icons_model="climacell",this._iconsConfig.path=i?Re:s?Ie:null,this._iconsConfig.iconType=e.animation?"animated":"static",this._iconsConfig.iconsDay=_e,this._iconsConfig.iconsNight=ye,this._iconsConfig.icons_model="climacell",e.weather&&e.weather.icons_model)switch(e.weather.icons_model.toLowerCase()){case"darksky":this._iconsConfig.iconsDay=ve,this._iconsConfig.iconsNight=we,this._iconsConfig.icons_model="darksky";break;case"openweathermap":this._iconsConfig.iconsDay=be,this._iconsConfig.iconsNight=Se,this._iconsConfig.icons_model="openweathermap"}this._config=e}getCardSize(){return 1}static get styles(){return ae`${de}${he}${ue}${pe}${me}${ge}`}render(){return this.invalidConfig?j`
  ...
  `})(this.hass,this._config.air_quality,r>0),r++):s=""}else s="";if(this._showUv&&this._hasUv){let e=this._config.uv;e.protection_window&&void 0!==typeof a[e.protection_window]||e.ozone_level&&void 0!==typeof a[e.ozone_level]||e.uv_index&&void 0!==typeof a[e.uv_index]||e.uv_level&&void 0!==typeof a[e.uv_level]||e.max_uv_index&&void 0!==typeof a[e.max_uv_index]?(i=Le(this.hass,this._config.uv,r>0),r++):i=""}else i="";if(this._showPollen&&this._hasPollen){let e=this._config.pollen;e.grass&&e.grass.entity&&void 0!==typeof a[e.grass.entity]||e.tree&&e.tree.entity&&void 0!==typeof a[e.tree.entity]||e.weed&&e.weed.entity&&void 0!==typeof a[e.weed.entity]?(n=function(e,t,i){let s=t.tree&&t.tree.entity?Ve(e,t.tree):void 0,n=t.weed&&t.weed.entity?Ve(e,t.weed):void 0,o=t.grass&&t.grass.entity?Ve(e,t.grass):void 0;return j`
  ...
  `}(this.hass,this._config.pollen,r>0),r++):n=""}else n="";if(this._showForecast&&this._hasForecast){let e=this._config.weather.forecast;o=((e,t,i,s,n,o)=>{let r=new Date,a=t.sun&&e.states[t.sun]?e.states[t.sun].state:void 0,l=i.icons?Object.entries(i.icons):void 0,c=i.temperature_high?Object.entries(i.temperature_high):void 0,d=i.temperature_low?Object.entries(i.temperature_low):void 0,h=i.precipitation_probability?Object.entries(i.precipitation_probability):void 0,p=i.precipitation_intensity?Object.entries(i.precipitation_intensity):void 0,u=Math.max(l?l.length:0,c?c.length:0,d?d.length:0,h?h.length:0,p?p.length:0),m=1,g=u>0?Array(u-m).fill(1,0,u-m).map(()=>m++):Array();return u>1?j`
    ...
    `}renderCamera(e,t){let i=e.states[t],s=i?i.attributes.entity_picture:void 0;return s?j`
      ...
      `:j``}handlePopup(e,t){e.stopPropagation();let i=new Event("hass-more-info",{composed:!0});i.detail={entityId:t},this.dispatchEvent(i)}};e([se()],n.prototype,"hass",void 0),e([se()],n.prototype,"_config",void 0),n=e([ee("ha-card-weather-conditions")],n)});export{De as hacsImagePathExist,He as manImagePathExist};
