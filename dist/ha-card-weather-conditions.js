...
`,_e={freezing_rain_heavy:"rainy-3",freezing_rain:"rainy-2",freezing_rain_light:"rainy-1",freezing_drizzle:"rain-and-sleet-mix",ice_pellets_heavy:"rain-and-snow-mix",ice_pellets:"rain-and-snow-mix",ice_pellets_light:"rain-and-snow-mix",snow_heavy:"snowy-3",snow:"snowy-2",snow_light:"snowy-1",flurries:"wind",tstorm:"tropical-storm",rain_heavy:"rainy-3",rain_light:"rainy-1",rain:"rainy-2",drizzle:"rainy-1",fog_light:"haze",fog:"fog",cloudy:"cloudy-original",mostly_cloudy:"cloudy-day-3",partly_cloudy:"cloudy-day-2",mostly_clear:"cloudy-day-1",clear:"day"},ye=Object.assign(Object.assign({},_e),{freezing_rain_heavy:"rainy-6",freezing_rain:"rainy-5",freezing_rain_light:"rainy-4",snow_heavy:"snowy-6",snow:"nowy-5",snow_light:"nowy-4",rain_heavy:"rainy-6",rain_light:"rainy-4",rain:"rainy-5",drizzle:"rainy-4",mostly_cloudy:"cloudy-night-3",partly_cloudy:"cloudy-night-2",mostly_clear:"cloudy-night-1",clear:"night"}),fe={freezing_rain_heavy:"rainy-3",freezing_rain:"rainy-2",freezing_rain_light:"rainy-1",freezing_drizzle:"rain-and-sleet-mix",ice_pellets_heavy:"rain-and-snow-mix",ice_pellets:"rain-and-snow-mix",ice_pellets_light:"rain-and-snow-mix",snow_heavy:"snowy-3",snow:"snowy-2",snow_light:"snowy-1",flurries:"wind",tstorm:"tropical-storm",rain_heavy:"rainy-3",rain_light:"rainy-1",rain:"rainy-2",drizzle:"rainy-1",fog_light:"haze",fog:"fog",cloudy:"cloudy-original",mostly_cloudy:"day-cloud-3.jpg",partly_cloudy:"day-cloud-2.jpg",mostly_clear:"day-cloud-1.jpg",clear:"day-clear.jpg"},ve={clear:"day","clear-day":"day",rain:"rainy-2",snow:"nowy-2",sleet:"rain-and-sleet-mix",wind:"cloudy-day-1",fog:"fog",cloudy:"cloudy-original","partly-cloudy-day":"cloudy-day-2"},we=Object.assign(Object.assign({},ve),{clear:"night","clear-night":"night",wind:"cloudy-night-1","partly-cloudy-day":"cloudy-night-2","partly-cloudy-night":"cloudy-night-2"}),be={"clear sky":"day","few clouds":"cloudy-day-1","scattered clouds":"cloudy-day-2","broken clouds":"cloudy-day-3","shower rain":"rainy-3",rain:"rainy-2",thunderstorm:"tropical-storm",snow:"nowy-2",mist:"fog"},xe=Object.assign(Object.assign({},be),{"clear sky":"day-night","few clouds":"cloudy-night-1","scattered clouds":"cloudy-night-2","broken clouds":"cloudy-night-3"});let Se={en:0,it:1,nl:2},Ne={N:["N","N","N"],NNE:["NNE","NNE","NNO"],NE:["NE","NE","NO"],ENE:["ENE","ENE","ONO"],E:["E","E","O"],ESE:["ESE","ESE","OZO"],SE:["SE","SE","ZO"],SSE:["SSE","SSE","ZZO"],S:["S","S","Z"],SSW:["SSW","SSO","ZZW"],SW:["SW","SO","ZW"],WSW:["WSW","OSO","WZW"],W:["W","O","W"],WNW:["WNW","ONO","WNW"],NW:["NW","NO","NW"],NNW:["NNW","NNO","NNW"]},Ce={"Feels Like":["Feels Like","Percepita","Voelt Als"],new_moon:["New moon","Novilunio",""],waxing_crescent:["Waxing crescent","Luna crescente",""],first_quarter:["First quarter","Primo Quarto",""],waxing_gibbous:["Waxing Gibbous","Gibbosa crescente",""],full:["Full","Luna piena",""],waning_gibbous:["Waning Gibbous","Gibbosa calante",""],third_quarter:["Third Quarter","Ultimo quarto",""],waning_crescent:["Waning Crescent","Luna calante",""]},$e={new_moon:"🌑",waxing_crescent:"🌒",first_quarter:"🌓",waxing_gibbous:"🌔",full:"🌕",waning_gibbous:"🌖",third_quarter:"🌗",waning_crescent:"🌘"};function Pe(e){return new Promise(t=>{setTimeout(()=>{let i=new Image;i.onload=(()=>{t(!0)}),i.onerror=(()=>{t(!1)}),i.src=e},100)})}const ke=(e,t)=>Ce[e][Se[t]],Ee=(e,t,i)=>{let s=i&&"below_horizon"==i,n=s?t.iconsNight[e]:t.iconsDay[e];return null==t.path&&console.info("Image path not found. (hacsImagePathExist="+Re+")(manImagePathExist="+qe),void 0===n&&console.info("Icons issue. States: icons_model="+t.icons_model+" - isDay="+!s+" - condition: "+e+"."),`${t.path}/${t.iconType}/${n}.svg`},Oe=(e,t)=>{const i=e.config.unit_system.length;switch(t){case"air_pressure":return"km"===i?"hPa":"inHg";case"length":return i;case"precipitation":return"km"===i?"mm":"in";default:return e.config.unit_system[t]||""}};const ze=(e,t,i,s,n)=>{let o,r,a=t.sun&&e.states[t.sun]?e.states[t.sun].state:void 0,l=t.moon_phase&&e.states[t.moon_phase]?e.states[t.moon_phase].state:void 0,c=l?function(e){return $e[e.toLowerCase()]}(l):void 0,d=t.current_conditions&&e.states[t.current_conditions]?e.states[t.current_conditions].state:"Na";return o=t.temperature&&e.states[t.temperature]?"°F"==Oe(e,"temperature")?Math.round(parseFloat(e.states[t.temperature].state)):parseFloat(e.states[t.temperature].state):"Na",r=t.feels_like&&e.states[t.feels_like]?"F"==e.states[t.feels_like].attributes.unit_of_measurement?Math.round(parseFloat(e.states[t.feels_like].state)):parseFloat(e.states[t.feels_like].state):"Na",M`
  ...
  `},We=(e,t,i,s)=>null==e&&null==i?M``:null==e?M`
            <div class="highTemp">
              <b>${i}</b> ${s}
            </div>   
      `:null==i?M`
...
        <text x="0" y="14" class="small">${t}</text>
  ...
  `}(this.hass,this._config.pollen),o++):s=""}else s="";if(this._showForecast&&this._hasForecast){let e=this._config.weather.forecast;n=((e,t,i,s,n)=>{let o=new Date,r=t.sun&&e.states[t.sun]?e.states[t.sun].state:void 0,a=i.icons?Object.entries(i.icons):void 0,l=i.temperature_high?Object.entries(i.temperature_high):void 0,c=i.temperature_low?Object.entries(i.temperature_low):void 0,d=i.precipitation_probability?Object.entries(i.precipitation_probability):void 0,h=i.precipitation_intensity?Object.entries(i.precipitation_intensity):void 0,p=Math.max(a?a.length:0,l?l.length:0,c?c.length:0,d?d.length:0,h?h.length:0),u=1,g=p>0?Array(p-u).fill(1,0,p-u).map(()=>u++):Array();return p>1?M`
      <div class="forecast clear">
        ${g.map(t=>{let i,p,u,g,m,_=new Date(o.setDate(o.getDate()+1)).toLocaleDateString(n,{weekday:"short"});return a&&a[t]&&e.states[a[t][1]]&&(i=e.states[a[t][1]].state.toLowerCase()),c&&c[t]&&e.states[c[t][1]]&&(p=Math.round(parseFloat(e.states[c[t][1]].state))),l&&l[t]&&e.states[l[t][1]]&&(u=Math.round(parseFloat(e.states[l[t][1]].state))),d&&d[t]&&e.states[d[t][1]]&&(g=Math.round(parseFloat(e.states[d[t][1]].state))),h&&h[t]&&e.states[h[t][1]]&&(m=Math.round(parseFloat(e.states[h[t][1]].state))),M`
          <div class="day ${t}">
              ...
              ${i?M`
              <i class="icon" style="background: none, url('${Ee(i,s,r)}') no-repeat; 
                    background-size: contain"></i>                
              `:""}
              ${We(p,"",u,Oe(e,"temperature"))} 
              ${We(g,"%",m,Oe(e,"precipitation")+"/h")}                       
          </div>
          `})}
      </div>
    ...
    `}renderCamera(e,t){let i=e.states[t],s=i?i.attributes.entity_picture:void 0;return s?M`
      ...
      `:M``}handlePopup(e,t){e.stopPropagation();let i=new Event("hass-more-info",{composed:!0});i.detail={entityId:t},this.dispatchEvent(i)}};e([se()],n.prototype,"hass",void 0),e([se()],n.prototype,"_config",void 0),n=e([ee("ha-card-weather-conditions")],n)});export{Re as hacsImagePathExist,qe as manImagePathExist};
