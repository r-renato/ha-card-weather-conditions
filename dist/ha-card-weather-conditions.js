...
`,_e={freezing_rain_heavy:"rainy-3",freezing_rain:"rainy-2",freezing_rain_light:"rainy-1",freezing_drizzle:"rain-and-sleet-mix",ice_pellets_heavy:"rain-and-snow-mix",ice_pellets:"rain-and-snow-mix",ice_pellets_light:"rain-and-snow-mix",snow_heavy:"snowy-3",snow:"snowy-2",snow_light:"snowy-1",flurries:"wind",tstorm:"tropical-storm",rain_heavy:"rainy-3",rain_light:"rainy-1",rain:"rainy-2",drizzle:"rainy-1",fog_light:"haze",fog:"fog",cloudy:"cloudy-original",mostly_cloudy:"cloudy-day-3",partly_cloudy:"cloudy-day-2",mostly_clear:"cloudy-day-1",clear:"day"},ye=Object.assign(Object.assign({},_e),{freezing_rain_heavy:"rainy-6",freezing_rain:"rainy-5",freezing_rain_light:"rainy-4",snow_heavy:"snowy-6",snow:"nowy-5",snow_light:"nowy-4",rain_heavy:"rainy-6",rain_light:"rainy-4",rain:"rainy-5",drizzle:"rainy-4",mostly_cloudy:"cloudy-night-3",partly_cloudy:"cloudy-night-2",mostly_clear:"cloudy-night-1",clear:"night"}),fe={freezing_rain_heavy:"rainy-3",freezing_rain:"rainy-2",freezing_rain_light:"rainy-1",freezing_drizzle:"rain-and-sleet-mix",ice_pellets_heavy:"rain-and-snow-mix",ice_pellets:"rain-and-snow-mix",ice_pellets_light:"rain-and-snow-mix",snow_heavy:"snowy-3",snow:"snowy-2",snow_light:"snowy-1",flurries:"wind",tstorm:"tropical-storm",rain_heavy:"rainy-3",rain_light:"rainy-1",rain:"rainy-2",drizzle:"rainy-1",fog_light:"haze",fog:"fog",cloudy:"cloudy-original",mostly_cloudy:"day-cloud-3.jpg",partly_cloudy:"day-cloud-2.jpg",mostly_clear:"day-cloud-1.jpg",clear:"day-clear.jpg"},ve={clear:"day","clear-day":"day",rain:"rainy-2",snow:"nowy-2",sleet:"rain-and-sleet-mix",wind:"cloudy-day-1",fog:"fog",cloudy:"cloudy-original","partly-cloudy-day":"cloudy-day-2"},we=Object.assign(Object.assign({},ve),{clear:"night","clear-night":"night",wind:"cloudy-night-1","partly-cloudy-day":"cloudy-night-2","partly-cloudy-night":"cloudy-night-2"}),be={"clear sky":"day","few clouds":"cloudy-day-1","scattered clouds":"cloudy-day-2","broken clouds":"cloudy-day-3","shower rain":"rainy-3",rain:"rainy-2",thunderstorm:"tropical-storm",snow:"nowy-2",mist:"fog"},Se=Object.assign(Object.assign({},be),{"clear sky":"day-night","few clouds":"cloudy-night-1","scattered clouds":"cloudy-night-2","broken clouds":"cloudy-night-3"});let xe={en:0,it:1,nl:2,es:3},Ne={N:["N","N","N","N"],NNE:["NNE","NNE","NNO","NNE"],NE:["NE","NE","NO","NE"],ENE:["ENE","ENE","ONO","ENE"],E:["E","E","O","E"],ESE:["ESE","ESE","OZO","ESE"],SE:["SE","SE","ZO","SE"],SSE:["SSE","SSE","ZZO","SSE"],S:["S","S","Z","S"],SSW:["SSW","SSO","ZZW","SSO"],SW:["SW","SO","ZW","SO"],WSW:["WSW","OSO","WZW","OSO"],W:["W","O","W","O"],WNW:["WNW","ONO","WNW","ONO"],NW:["NW","NO","NW","NO"],NNW:["NNW","NNO","NNW","NNO"]},Ce={"Feels Like":["Feels Like","Percepita","Voelt Als","Parece que"],new_moon:["New moon","Novilunio","Nieuwe maan","Luna nueva"],waxing_crescent:["Waxing crescent","Luna crescente","Wassende sikkel","Media luna de cera"],first_quarter:["First quarter","Primo Quarto","Eerste kwartaal","Primer trimestre"],waxing_gibbous:["Waxing Gibbous","Gibbosa crescente","Wassen Gibbous","Encerado Gibbous"],full:["Full","Luna piena","Volledig","Completo"],waning_gibbous:["Waning Gibbous","Gibbosa calante","Zwemmende Gibbous","Waning Gibbous"],third_quarter:["Third Quarter","Ultimo quarto","Derde Kwartier","Tercer cuarto"],last_quarter:["Last Quarter","Ultimo quarto","Laatste Kwartier","Último cuarto"],waning_crescent:["Waning Crescent","Luna calante","Zwemmende sikkel","Waning Crescent"]},$e={new_moon:"🌑",waxing_crescent:"🌒",first_quarter:"🌓",waxing_gibbous:"🌔",full:"🌕",waning_gibbous:"🌖",third_quarter:"🌗",last_quarter:"🌗",waning_crescent:"🌘"};function Ee(e){return new Promise(t=>{setTimeout(()=>{let i=new Image;i.onload=(()=>{t(!0)}),i.onerror=(()=>{t(!1)}),i.src=e},100)})}const Pe=(e,t)=>Ce[e][xe[t]],ke=(e,t,i)=>{let s=i&&"below_horizon"==i,n=s?t.iconsNight[e]:t.iconsDay[e];return null==t.path&&console.info("Image path not found. (hacsImagePathExist="+qe+")(manImagePathExist="+Le),void 0===n&&console.info("Icons issue. States: icons_model="+t.icons_model+" - isDay="+!s+" - condition: "+e+"."),`${t.path}/${t.iconType}/${n}.svg`},Oe=(e,t)=>{const i=e.config.unit_system.length;switch(t){case"air_pressure":return"km"===i?"hPa":"inHg";case"length":return i;case"precipitation":return"km"===i?"mm":"in";default:return e.config.unit_system[t]||""}};const ze=(e,t,i,s,n)=>{let o,r,a=t.sun&&e.states[t.sun]?e.states[t.sun].state:void 0,l=t.moon_phase&&e.states[t.moon_phase]?e.states[t.moon_phase].state:void 0,c=l?function(e){return $e[e.toLowerCase()]}(l):void 0,d=t.current_conditions&&e.states[t.current_conditions]?e.states[t.current_conditions].state:"Na";return o=t.temperature&&e.states[t.temperature]?"°F"==Oe(e,"temperature")?Math.round(parseFloat(e.states[t.temperature].state)):parseFloat(e.states[t.temperature].state):"Na",r=t.feels_like&&e.states[t.feels_like]?"F"==e.states[t.feels_like].attributes.unit_of_measurement?Math.round(parseFloat(e.states[t.feels_like].state)):parseFloat(e.states[t.feels_like].state):"Na",M`
      ...
      ${"Na"!==r?M`
        <ul class="variations polles" style="border: 0;margin-top: 4px;">
          ...
          <li>
            <ha-icon icon="${e.states[t.feels_like].attributes.icon}"></ha-icon>${Pe("Feels Like",n)} ${r}
            <span class="unit"> ${Oe(e,"temperature")}</span>
          </li>
        </ul>      
      `:""}
   `},Te=(e,t,i,s,n)=>void 0!==e||void 0!==i?M`
    <li>
  ...
  `,We=(e,t,i,s,n)=>{let o,r,a,l,c,d;const h=s||e.selectedLanguage||e.language;let p=t.sun?e.states[t.sun]:void 0;if(p&&(c=new Date(p.attributes.next_rising),d=new Date(p.attributes.next_setting)),t.forecast){let t=i.temperature_high?Object.entries(i.temperature_high):void 0,s=i.temperature_low?Object.entries(i.temperature_low):void 0,n=i.precipitation_probability?Object.entries(i.precipitation_probability):void 0,c=i.precipitation_intensity?Object.entries(i.precipitation_intensity):void 0;o=t?Math.round(parseFloat(e.states[t[0][1]].state)):void 0,r=s?Math.round(parseFloat(e.states[s[0][1]].state)):void 0,a=n?Math.round(parseFloat(e.states[n[0][1]].state)):void 0,l=c?Math.round(parseFloat(e.states[c[0][1]].state)):void 0}let u=t.precipitation?Math.round(parseFloat(e.states[t.precipitation].state)):void 0,g=t.humidity?parseFloat(e.states[t.humidity].state):void 0,m=t.wind_bearing?parseFloat(e.states[t.wind_bearing].state):void 0,_=t.wind_speed?Math.round(10*parseFloat(e.states[t.wind_speed].state))/10:void 0,y=t.pressure?Math.round(parseFloat(e.states[t.pressure].state)):void 0,f=t.visibility?Math.round(parseFloat(e.states[t.visibility].state)):void 0;return M`
    <ul class="variations ${n?"spacer":""}">
        ...
        ${void 0!==g?Ae(g,"%","mdi:water-percent"):""}
        ${void 0!==f?Ae(f,Oe(e,"length"),"mdi:weather-fog"):""}
        ${_||m?M`
          <li>
            <ha-icon icon="mdi:weather-windy"></ha-icon> ${((e,t)=>e<0||e>360?(console.log("Enter a degree between 0 and 360 degrees."),null):e>=0&&e<=11.25?Ne.N[xe[t]]:e>348.75&&e<=360?Ne.N[xe[t]]:e>11.25&&e<=33.75?Ne.NNE[xe[t]]:e>33.75&&e<=56.25?Ne.NE[xe[t]]:e>56.25&&e<=78.75?Ne.ENE[xe[t]]:e>78.75&&e<=101.25?Ne.E[xe[t]]:e>101.25&&e<=123.75?Ne.ESE[xe[t]]:e>123.75&&e<=146.25?Ne.SE[xe[t]]:e>146.25&&e<=168.75?Ne.SSE[xe[t]]:e>168.75&&e<=191.25?Ne.S[xe[t]]:e>191.25&&e<=213.75?Ne.SSW[xe[t]]:e>213.75&&e<=236.25?Ne.SW[xe[t]]:e>236.25&&e<=258.75?Ne.WSW[xe[t]]:e>258.75&&e<=281.25?Ne.W[xe[t]]:e>281.25&&e<=303.75?Ne.WNW[xe[t]]:e>303.75&&e<=326.25?Ne.NW[xe[t]]:e>326.25&&e<=348.75?Ne.NNW[xe[t]]:null)(m,h)} ${_}
  ...
  `},Fe=(e,t,i,s)=>null==e&&null==i?M``:null==e?M`
            <div class="highTemp">
              <b>${i}</b> ${s}
            </div>   
      `:null==i?M`
      ...
      `,Ve=(e,t)=>{let i=e.states[t.entity],s=void 0!==t.min?t.min:0,n=void 0!==t.max?t.max:5,o=void 0!==t.low?t.low:s,r=void 0!==t.high?t.high:n,a=0==s?1:0;return i?M`
     <li>
...
        <text x="0" y="14" class="small">${t}</text>
  ...
  `:"",Me="/local/community/ha-card-weather-conditions/icons",Ue="/local/ha-card-weather-conditions/icons";let qe=!1,Le=!1,Re="%c WEATHER-CONDITION-CARD %c 1.4.0",De="color: white; background: green; font-weight: 700;",Ie="color: green; background: white; font-weight: 700;",He="color: black; background: white; font-weight: 700;";console.info(Re,De,Ie),Promise.all([Ee(Me+"/static/cloudy.svg"),Ee(Ue+"/static/cloudy.svg")]).then(t=>{let i,s;i=qe=t[0],s=Le=t[1],i?console.info(Re+"%c use HACS path to retrieve icons.",De,Ie,He):s?console.info(Re+"%c use www root path to retrieve icons.",De,Ie,He):console.info(Re+"%c error setting right icons path.",De,Ie,He);let n=class extends ce{constructor(){super(...arguments),this._iconsConfig=new class{},this._bgConfig=new class{},this.invalidConfig=!1,this.numberElements=0,this._header=!0,this._name="",this._hasCurrent=!1,this._hasForecast=!1,this._hasMeteogram=!1,this._hasAirQuality=!1,this._hasPollen=!1,this._displayTop=!0,this._displayCurrent=!0,this._displayForecast=!0,this._showSummary=!0,this._showPresent=!0,this._showAirQuality=!0,this._showPollen=!0,this._showForecast=!0}setConfig(e){if(console.log({card_config:e}),!e)throw this.invalidConfig=!0,new Error("Invalid configuration");if(e.name&&e.name.length>0&&(this._name=e.name),e.language&&e.language.length>0?this._language=e.language.toLowerCase():this._language="en",void 0!==e.display&&(this._displayTop=e.display.findIndex(e=>"top"===e.toLowerCase())>=0,this._displayCurrent=e.display.findIndex(e=>"current"===e.toLowerCase())>=0,this._displayForecast=e.display.findIndex(e=>"forecast"===e.toLowerCase())>=0),this._hasCurrent=!!e.weather&&!!e.weather.current,this._hasForecast=!!e.weather&&!!e.weather.forecast,this._hasMeteogram=this._hasForecast&&!!e.weather.forecast.meteogram,this._hasAirQuality=!!e.air_quality,this._hasPollen=!(!e.pollen||!e.pollen.tree&&!e.pollen.weed&&!e.pollen.grass),this._bgConfig.path=i?Me:s?Ue:null,this._bgConfig.iconsDay=fe,this._bgConfig.icons_model="climacell",this._iconsConfig.path=i?Me:s?Ue:null,this._iconsConfig.iconType=e.animation?"animated":"static",this._iconsConfig.iconsDay=_e,this._iconsConfig.iconsNight=ye,this._iconsConfig.icons_model="climacell",e.weather&&e.weather.icons_model)switch(e.weather.icons_model.toLowerCase()){case"darksky":this._iconsConfig.iconsDay=ve,this._iconsConfig.iconsNight=we,this._iconsConfig.icons_model="darksky";break;case"openweathermap":this._iconsConfig.iconsDay=be,this._iconsConfig.iconsNight=Se,this._iconsConfig.icons_model="openweathermap"}this._config=e}getCardSize(){return 1}static get styles(){return ae`${de}${he}${ue}${pe}${ge}${me}`}render(){return this.invalidConfig?M`
        ...
        `:this._render()}_render(){let e,t,i,s,n,o=0,r=this.hass.states;if(this._showSummary&&this._hasCurrent){let t=this._config.weather.current;t.current_conditions&&void 0!==typeof r[t.current_conditions]||t.temperature&&void 0!==typeof r[t.temperature]?(e=ze(this.hass,this._config.weather.current,this._config.name,this._iconsConfig,this._language),o++):e=""}else e="";if(this._showPresent&&this._hasCurrent){let e=this._config.weather.current;if(e.sun&&void 0!==typeof r[e.sun]||e.humidity&&void 0!==typeof r[e.humidity]||e.pressure&&void 0!==typeof r[e.pressure]||e.visibility&&void 0!==typeof r[e.visibility]||e.wind_bearing&&void 0!==typeof r[e.wind_bearing]||e.wind_speed&&void 0!==typeof r[e.wind_speed])t=We(this.hass,this._config.weather.current,this._config.weather.forecast,this._language,o>0),o++;else if(e.forecast&&this._hasForecast){let e=this._config.weather.forecast;e.temperature_low&&e.temperature_low.day_1&&void 0!==typeof r[e.temperature_low.day_1]||e.temperature_high&&e.temperature_high.day_1&&void 0!==typeof r[e.temperature_high.day_1]||e.precipitation_intensity&&e.precipitation_intensity.day_1&&void 0!==typeof r[e.precipitation_intensity.day_1]||e.precipitation_probability&&e.precipitation_probability.day_1&&void 0!==typeof r[e.precipitation_probability.day_1]?(t=We(this.hass,this._config.weather.current,this._config.weather.forecast,this._language,o>0),o++):t=""}else t=""}else t="";if(this._showAirQuality&&this._hasAirQuality){let e=this._config.air_quality;e.co&&void 0!==typeof r[e.co]||e.epa_aqi&&void 0!==typeof r[e.epa_aqi]||e.epa_health_concern&&void 0!==typeof r[e.epa_health_concern]||e.no2&&void 0!==typeof r[e.no2]||e.o3&&void 0!==typeof r[e.o3]||e.pm10&&void 0!==typeof r[e.pm10]||e.pm25&&void 0!==typeof r[e.pm25]||e.so2&&void 0!==typeof r[e.so2]?(i=((e,t,i)=>{let s=void 0!==t.pm25?je(e.states[t.pm25],"pm25"):void 0,n=void 0!==t.pm10?je(e.states[t.pm10],"pm10"):void 0,o=void 0!==t.o3?je(e.states[t.o3],"o3"):void 0,r=void 0!==t.no2?je(e.states[t.no2],"no2"):void 0,a=void 0!==t.co?je(e.states[t.co],"co"):void 0,l=void 0!==t.so2?je(e.states[t.so2],"so2"):void 0,c=void 0!==t.epa_aqi?je(e.states[t.epa_aqi],"aqi"):void 0,d=void 0!==t.epa_health_concern?je(e.states[t.epa_health_concern],"aqi"):void 0;return M`
    <ul class="variations ${i?"spacer":""}">
        ${c||""}${d||""}
        ${s||""}${n||""}${o||""}${r||""}${a||""}${l||""}
    </ul>
  `})(this.hass,this._config.air_quality,o>0),o++):i=""}else i="";if(this._showPollen&&this._hasPollen){let e=this._config.pollen;e.grass&&e.grass.entity&&void 0!==typeof r[e.grass.entity]||e.tree&&e.tree.entity&&void 0!==typeof r[e.tree.entity]||e.weed&&e.weed.entity&&void 0!==typeof r[e.weed.entity]?(s=function(e,t){let i=t.tree&&t.tree.entity?Ve(e,t.tree):void 0,s=t.weed&&t.weed.entity?Ve(e,t.weed):void 0,n=t.grass&&t.grass.entity?Ve(e,t.grass):void 0;return M`
    <ul class="variations polles">
        ${i||""}${s||""}${n||""}
    </ul>
  `}(this.hass,this._config.pollen),o++):s=""}else s="";if(this._showForecast&&this._hasForecast){let e=this._config.weather.forecast;n=((e,t,i,s,n)=>{let o=new Date,r=t.sun&&e.states[t.sun]?e.states[t.sun].state:void 0,a=i.icons?Object.entries(i.icons):void 0,l=i.temperature_high?Object.entries(i.temperature_high):void 0,c=i.temperature_low?Object.entries(i.temperature_low):void 0,d=i.precipitation_probability?Object.entries(i.precipitation_probability):void 0,h=i.precipitation_intensity?Object.entries(i.precipitation_intensity):void 0,p=Math.max(a?a.length:0,l?l.length:0,c?c.length:0,d?d.length:0,h?h.length:0),u=1,g=p>0?Array(p-u).fill(1,0,p-u).map(()=>u++):Array();return p>1?M`
      <div class="forecast clear">
        ${g.map(t=>{let i,p,u,g,m,_=new Date(o.setDate(o.getDate()+1)).toLocaleDateString(n,{weekday:"short"});return a&&a[t]&&e.states[a[t][1]]&&(i=e.states[a[t][1]].state.toLowerCase()),c&&c[t]&&e.states[c[t][1]]&&(p=Math.round(parseFloat(e.states[c[t][1]].state))),l&&l[t]&&e.states[l[t][1]]&&(u=Math.round(parseFloat(e.states[l[t][1]].state))),d&&d[t]&&e.states[d[t][1]]&&(g=Math.round(parseFloat(e.states[d[t][1]].state))),h&&h[t]&&e.states[h[t][1]]&&(m=Math.round(parseFloat(e.states[h[t][1]].state))),M`
          <div class="day ${t}">
              <div class="dayname">${_}</div>
              ${i?M`
              <i class="icon" style="background: none, url('${ke(i,s,r)}') no-repeat; 
                    background-size: contain"></i>                
              `:""}
              ${Fe(p,"",u,Oe(e,"temperature"))} 
              ${Fe(g,"%",m,Oe(e,"precipitation")+"/h")}                       
          </div>
          `})}
      </div>
    `:M``})(this.hass,this._config.weather.current,e,this._iconsConfig,this._language),o++}else n="";return M`
      ${""}
    ...
    `}renderCamera(e,t){let i=e.states[t],s=i?i.attributes.entity_picture:void 0;return s?M`
        <div @click=${e=>this.handlePopup(e,t)} class="camera-container">
          <div class="camera-image">
            <img src="${s}" alt="${i.attributes.friendly_name}"/>
          </div>
        </div>
      `:M``}handlePopup(e,t){e.stopPropagation();let i=new Event("hass-more-info",{composed:!0});i.detail={entityId:t},this.dispatchEvent(i)}};e([se()],n.prototype,"hass",void 0),e([se()],n.prototype,"_config",void 0),n=e([ee("ha-card-weather-conditions")],n)});export{qe as hacsImagePathExist,Le as manImagePathExist};
