...
`;let _t={en:0,it:1},yt={N:["N","N"],NNE:["NNE","NNE"],NE:["NE","NE"],ENE:["ENE","ENE"],E:["E","E"],ESE:["ESE","ESE"],SE:["SE","SE"],SSE:["SSE","SSE"],S:["S","S"],SSW:["SSW","SSO"],SW:["SW","SO"],WSW:["WSW","OSO"],W:["W","O"],WNW:["WNW","ONO"],NW:["NW","NO"],NNW:["NNW","NNO"]};function ft(t){return new Promise(e=>{setTimeout(()=>{let i=new Image;i.onload=(()=>{e(!0)}),i.onerror=(()=>{e(!1)}),i.src=t},100)})}const vt=(t,e,i)=>{let s=i&&"below_horizon"==i,n=s?e.iconsNight[t]:e.iconsDay[t];return null==e.path&&console.info("Image path not found. (hacsImagePathExist="+kt+")(manImagePathExist="+Tt),void 0===n&&console.info("Icons issue. States: icons_model="+e.icons_model+" - isDay="+!s+" - condition: "+t+"."),`${e.path}/${e.iconType}/${n}.svg`},wt=(t,e)=>{const i=t.config.unit_system.length;switch(e){case"air_pressure":return"km"===i?"hPa":"inHg";case"length":return i;case"precipitation":return"km"===i?"mm":"in";default:return t.config.unit_system[e]||""}},bt=(t,e,i,s,n)=>void 0!==t||void 0!==i?j`
    <li>
    ...
    <ul class="variations">
        ...
        ${g||m?j`
          <li>
            ...
            <span class="unit">${wt(t,"length")}/h</span>
          </li>
        `:""}        
        ${void 0!==l?St(l.toLocaleTimeString(),"","mdi:weather-sunset-up"):""}               
        ${void 0!==c?St(c.toLocaleTimeString(),"","mdi:weather-sunset-down"):""}           
    </ul>
  `},Nt=(t,e,i,s)=>null==t&&null==i?j``:null==t?j`
            <div class="highTemp">
              <b>${i}</b> ${s}
            </div>   
      `:null==i?j`
      ...
      `,Ct=(t,e)=>{let i=t.states[e.entity],s=void 0!==e.min?e.min:0,n=void 0!==e.max?e.max:5,r=void 0!==e.low?e.low:s,o=void 0!==e.high?e.high:n,a=0==s?1:0;return i?j`
     <li>
...
        <text x="0" y="14" class="small">${e}</text>
  ...
  `:"",Pt="/local/community/ha-card-weather-conditions/icons",$t="/local/ha-card-weather-conditions/icons";let kt=!1,Tt=!1,Ot="%c WEATHER-CONDITION-CARD %c 1.0.1",At="color: white; background: green; font-weight: 700;",zt="color: green; background: white; font-weight: 700;",Ft="color: black; background: white; font-weight: 700;";console.info(Ot,At,zt),Promise.all([ft(Pt+"/static/cloudy.svg"),ft($t+"/static/cloudy.svg")]).then(e=>{let i,s;i=kt=e[0],s=Tt=e[1],i?console.info(Ot+"%c use HACS path to retrieve icons.",At,zt,Ft):s?console.info(Ot+"%c use www root path to retrieve icons.",At,zt,Ft):console.info(Ot+"%c error setting right icons path.",At,zt,Ft);let n=class extends lt{constructor(){super(...arguments),this._iconsConfig=new class{},this.invalidConfig=!1,this.numberElements=0,this._header=!0,this._name="",this._hasCurrent=!1,this._hasForecast=!1,this._hasMeteogram=!1,this._hasAirQuality=!1,this._hasPollen=!1,this._displayTop=!0,this._displayCurrent=!0,this._displayForecast=!0}setConfig(t){if(console.log({card_config:t}),!t)throw this.invalidConfig=!0,new Error("Invalid configuration");if(t.name&&t.name.length>0&&(this._name=t.name),t.language&&t.language.length>0?this._language=t.language.toLowerCase():this._language="en",void 0!==t.display&&(this._displayTop=t.display.findIndex(t=>"top"===t.toLowerCase())>=0,this._displayCurrent=t.display.findIndex(t=>"current"===t.toLowerCase())>=0,this._displayForecast=t.display.findIndex(t=>"forecast"===t.toLowerCase())>=0),this._hasCurrent=!!t.weather&&!!t.weather.current,this._hasForecast=!!t.weather&&!!t.weather.forecast,this._hasMeteogram=this._hasForecast&&!!t.weather.forecast.meteogram,this._hasAirQuality=!!t.air_quality,this._hasPollen=!(!t.pollen||!t.pollen.tree&&!t.pollen.weed&&!t.pollen.grass),this._iconsConfig.path=i?Pt:s?$t:null,this._iconsConfig.iconType=t.animation?"animated":"static",this._iconsConfig.iconsDay=ct,this._iconsConfig.iconsNight=dt,this._iconsConfig.icons_model="climacell",t.weather&&t.weather.icons_model)switch(t.weather.icons_model.toLowerCase()){case"darksky":this._iconsConfig.iconsDay=ht,this._iconsConfig.iconsNight=pt,this._iconsConfig.icons_model="darksky";break;case"openweathermap":this._iconsConfig.iconsDay=ut,this._iconsConfig.iconsNight=mt,this._iconsConfig.icons_model="openweathermap"}this._config=t}getCardSize(){return 1}static get styles(){return gt}render(){return this._iconsConfig.path||(this._iconsConfig.path=kt?Pt:Tt?$t:null),this.invalidConfig?j`
      ...
      <ha-card class="ha-card-weather-conditions">
        ${this._header?j`
            ${this._hasCurrent&&this._displayTop?((t,e,i,s)=>{let n,r,o=e.sun&&t.states[e.sun]?t.states[e.sun].state:void 0,a=e.current_conditions&&t.states[e.current_conditions]?t.states[e.current_conditions].state:"Na";return n=e.temperature&&t.states[e.temperature]?"°F"==wt(t,"temperature")?Math.round(parseFloat(t.states[e.temperature].state)):parseFloat(t.states[e.temperature].state):"Na",r=e.feels_like&&t.states[e.feels_like]?"F"==t.states[e.feels_like].attributes.unit_of_measurement?Math.round(parseFloat(t.states[e.feels_like].state)):parseFloat(t.states[e.feels_like].state):"Na",j`
      <div class="current">
        <span class="icon bigger" style="background: none,
            url('${vt(a.toLowerCase(),s,o)}') no-repeat ; 
            background-size: contain;">${a}</span>
        ${i?j`<span class="title"> ${i} </span>`:""}
        <span class="temp">${n}</span>
        <span class="tempc"> ${wt(t,"temperature")}</span>
      </div>
      ${"Na"!==r?j`
        <ul class="variations polles" style="border: 0;margin-top: 4px;">
          <li><ha-icon icon="none"></ha-icon><span class="unit"></span></li>
          <li>
            <ha-icon icon="${t.states[e.feels_like].attributes.icon}"></ha-icon>Feels Like ${r}
            <span class="unit"> ${wt(t,"temperature")}</span>
          </li>
        </ul>      
      `:""}
   `})(this.hass,this._config.weather.current,this._config.name,this._iconsConfig):""}
            ${this._hasCurrent&&this._displayCurrent?xt(this.hass,this._config.weather.current,this._config.weather.forecast,this._language):""}
            ${this._hasAirQuality?((t,e)=>{let i=void 0!==e.pm25?Et(t.states[e.pm25],"pm25"):void 0,s=void 0!==e.pm10?Et(t.states[e.pm10],"pm10"):void 0,n=void 0!==e.o3?Et(t.states[e.o3],"o3"):void 0,r=void 0!==e.no2?Et(t.states[e.no2],"no2"):void 0,o=void 0!==e.co?Et(t.states[e.co],"co"):void 0,a=void 0!==e.so2?Et(t.states[e.so2],"so2"):void 0,l=void 0!==e.epa_aqi?Et(t.states[e.epa_aqi],"aqi"):void 0,c=void 0!==e.epa_health_concern?Et(t.states[e.epa_health_concern],"aqi"):void 0;return j`
    <ul class="variations polles">
        ${l||""}${c||""}
        ${i||""}${s||""}${n||""}${r||""}${o||""}${a||""}
    </ul>
  `})(this.hass,this._config.air_quality):""}
            ${this._hasPollen?function(t,e){let i=e.tree&&e.tree.entity?Ct(t,e.tree):void 0,s=e.weed&&e.weed.entity?Ct(t,e.weed):void 0,n=e.grass&&e.grass.entity?Ct(t,e.grass):void 0;return j`
    <ul class="variations polles">
        ${i||""}${s||""}${n||""}
    </ul>
  `}(this.hass,this._config.pollen):""}
      ...
      <div class="forecast clear">
        ${m.map(e=>{let i,p,u,m,g,_=new Date(r.setDate(r.getDate()+1)).toLocaleDateString(n,{weekday:"short"});return a&&a[e]&&t.states[a[e][1]]&&(i=t.states[a[e][1]].state.toLowerCase()),c&&c[e]&&t.states[c[e][1]]&&(p=Math.round(parseFloat(t.states[c[e][1]].state))),l&&l[e]&&t.states[l[e][1]]&&(u=Math.round(parseFloat(t.states[l[e][1]].state))),d&&d[e]&&t.states[d[e][1]]&&(m=Math.round(parseFloat(t.states[d[e][1]].state))),h&&h[e]&&t.states[h[e][1]]&&(g=Math.round(parseFloat(t.states[h[e][1]].state))),j`
          <div class="day ${e}">
              ...
              ${i?j`
              <i class="icon" style="background: none, url('${vt(i,s,o)}') no-repeat; 
                    background-size: contain"></i>                
              `:""}
              ${Nt(p,"",u,wt(t,"temperature"))} 
              ${Nt(m,"%",g,wt(t,"precipitation")+"/h")}                       
          </div>
          `})}
      </div>
    ...
    `}renderCamera(t,e){let i=t.states[e],s=i?i.attributes.entity_picture:void 0;return s?j`
      ...
      `:j``}handlePopup(t,e){t.stopPropagation();let i=new Event("hass-more-info",{composed:!0});i.detail={entityId:e},this.dispatchEvent(i)}};t([st()],n.prototype,"hass",void 0),t([st()],n.prototype,"_config",void 0),n=t([tt("ha-card-weather-conditions")],n)});export{kt as hacsImagePathExist,Tt as manImagePathExist};
