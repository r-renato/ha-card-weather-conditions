  ...
  `:""})(t.states[e.uv_index],t.states[e.max_uv_index],"mdi:weather-sunny"):"",a=void 0!==e.ozone_level&&t.states[e.ozone_level]?Zt(t.states[e.ozone_level],"mdi:vector-triangle",!0):void 0;return E`
    ...
    ${[1,2,3,4,5,6].map(i=>{let s=e["set_skin_type_"+i],n=void 0!==typeof s&&void 0!==typeof t.states[s]?t.states[s]:void 0;return n?E`
        <div class="day ${i}">
            ...
            <div class="lowTemp">
              ${(t=>{let e="- -";if(t&&"unknown"!==t){let i=Math.floor(parseInt(t)/60),s=t-60*i;e=i>0?i+":"+s+" h":s+" m"}return e})(n.state)}
            </div>  
        </div>
      `:""})}
    </div>
