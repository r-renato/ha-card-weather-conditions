...
`,xt={freezing_rain_heavy:"rainy-3",freezing_rain:"rainy-2",freezing_rain_light:"rainy-1",freezing_drizzle:"rain-and-sleet-mix",ice_pellets_heavy:"rain-and-snow-mix",ice_pellets:"rain-and-snow-mix",ice_pellets_light:"rain-and-snow-mix",snow_heavy:"snowy-3",snow:"snowy-2",snow_light:"snowy-1",flurries:"wind",tstorm:"tropical-storm",rain_heavy:"rainy-3",rain_light:"rainy-1",rain:"rainy-2",drizzle:"rainy-1",fog_light:"haze",fog:"fog",cloudy:"cloudy-original",mostly_cloudy:"cloudy-day-3",partly_cloudy:"cloudy-day-2",mostly_clear:"cloudy-day-1",clear:"day"},mt=Object.assign(Object.assign({},xt),{freezing_rain_heavy:"rainy-6",freezing_rain:"rainy-5",freezing_rain_light:"rainy-4",snow_heavy:"snowy-6",snow:"nowy-5",snow_light:"nowy-4",rain_heavy:"rainy-6",rain_light:"rainy-4",rain:"rainy-5",drizzle:"rainy-4",mostly_cloudy:"cloudy-night-3",partly_cloudy:"cloudy-night-2",mostly_clear:"cloudy-night-1",clear:"night"}),bt={clear:"day","clear-day":"day",rain:"rainy-2",snow:"nowy-2",sleet:"rain-and-sleet-mix",wind:"cloudy-day-1",fog:"fog",cloudy:"cloudy-original","partly-cloudy-day":"cloudy-day-2"},yt=Object.assign(Object.assign({},bt),{clear:"night","clear-night":"night",wind:"cloudy-night-1","partly-cloudy-day":"cloudy-night-2","partly-cloudy-night":"cloudy-night-2"}),_t={"clear sky":"day","few clouds":"cloudy-day-1","scattered clouds":"cloudy-day-2","broken clouds":"cloudy-day-3","shower rain":"rainy-3",rain:"rainy-2",thunderstorm:"tropical-storm",snow:"nowy-2",mist:"fog"},vt=Object.assign(Object.assign({},_t),{"clear sky":"day-night","few clouds":"cloudy-night-1","scattered clouds":"cloudy-night-2","broken clouds":"cloudy-night-3"});let ft={en:0,it:1,nl:2,es:3,de:4,fr:5,"sr-latn":6,pt:7},kt={new_moon:"🌑",new:"🌑",waxing_crescent:"🌒",first_quarter:"🌓",waxing_gibbous:"🌔",full:"🌕",waning_gibbous:"🌖",third_quarter:"🌗",last_quarter:"🌗",waning_crescent:"🌘"};function St(t){return new Promise(e=>{setTimeout(()=>{let i=new Image;i.onload=(()=>{e(!0)}),i.onerror=(()=>{e(!1)}),i.src=t},100)})}const Mt=(t,e)=>e[t]?e[t]:"ERR",It=(t,e,i)=>{let s=i&&"below_horizon"==i,n=s?e.iconsNight[t]:e.iconsDay[t];return null==e.path&&console.info("Image path not found. (hacsImagePathExist="+Qt+")(manImagePathExist="+Yt),void 0===n&&console.info("Icons issue. States: icons_model="+e.icons_model+" - isDay="+!s+" - condition: "+t+"."),`${e.path}/${e.iconType}/${n}.svg`},Nt=(t,e)=>{const i=t.config.unit_system.length;switch(e){case"air_pressure":return"km"===i?"hPa":"inHg";case"length":return i;case"precipitation":return"km"===i?"mm":"in";default:return t.config.unit_system[e]||""}};function jt(t){return new Promise(e=>{setTimeout(()=>{let i=new XMLHttpRequest;i.overrideMimeType("application/json"),i.open("GET",t,!0),i.onreadystatechange=(()=>{4===i.readyState&&200===i.status&&e(i.responseText)}),i.send(null)},100)})}function Ct(t,e=1){switch(e){case 0:return te.format(parseFloat(t));case 1:return ee.format(parseFloat(t))}}const zt=(t,e,i,s,n)=>{let o,a,r=e.sun&&t.states[e.sun]?t.states[e.sun].state:void 0,p=e.moon_phase&&t.states[e.moon_phase]?t.states[e.moon_phase].state:void 0,h=p?function(t){return kt[t.toLowerCase()]}(p):void 0,d=e.current_conditions&&t.states[e.current_conditions]?t.states[e.current_conditions].state:"Na";return o=e.temperature&&t.states[e.temperature]?Ct(t.states[e.temperature].state):"Na",a=e.feels_like&&t.states[e.feels_like]?Ct(t.states[e.feels_like].state):"Na",E`
  ...
  `},At=(t,e,i,s)=>null==t&&null==i?E``:null==t?E`
      ...
      `,Dt=(t,e)=>{let i=t.states[e.entity],s=void 0!==e.min?e.min:0,n=void 0!==e.max?e.max:5,o=void 0!==e.low?e.low:s,a=void 0!==e.high?e.high:n,r=0==s?1:0;return i?E`
     <li>
       <ha-icon icon="${i.attributes.icon}"></ha-icon>
       <meter class="meter" value="${parseInt(i.state)+r}" optimum="${(a-o)/2}"
            min="${s}" max="${n+r}" low="${o+r}" high="${a+r}">${i.state}/${n}</meter>
     </li>
  `:""};const $t=(t,e,i)=>t?E`
    <li>
...
        <text x="0" y="14" class="small">${i}</text>
  ...
  `}(this.hass,this._config.pollen,p>0),p++):n=""}else n="";if(this._showForecast&&this._hasForecast){let t=this._config.weather.forecast;o=((t,e,i,s,n,o)=>{let a=new Date,r=e.sun&&t.states[e.sun]?t.states[e.sun].state:void 0,p=i.icons?Object.entries(i.icons):void 0,h=i.temperature_high?Object.entries(i.temperature_high):void 0,d=i.temperature_low?Object.entries(i.temperature_low):void 0,c=i.precipitation_probability?Object.entries(i.precipitation_probability):void 0,l=i.precipitation_intensity?Object.entries(i.precipitation_intensity):void 0,g=Math.max(p?p.length:0,h?h.length:0,d?d.length:0,c?c.length:0,l?l.length:0),u=1,w=g>0?Array(g-u).fill(1,0,g-u).map(()=>u++):Array();return g>1?E`
    ...
    `:E``})(this.hass,this._config.weather.current,t,this._iconsConfig,this._language,p>0),p++}else o="";if(this._showAlert&&this._hasAlert){let t=this._config.alert;a=Ut(this.hass,t),p++}else a="";if(this._showSea&&this._hasSea){let t=this._config.sea;console.info("--------"),r=Rt(this.hass,t,this._iconsConfig,this._language,p>0),p++}else r="";return E`
      ${""}
